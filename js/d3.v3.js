d3 = function() {
  ...
  var d3_time_days = [ "Sonntag", "Montag", "Dienstag", "Mittwoch", "Donnerstag", "Freitag", "Samstag" ], d3_time_dayAbbreviations = [ "So.", "Mo.", "Di.", "Mi.", "Do.", "Fr.", "Sa." ], d3_time_months = [ "Januar", "Februar", "März", "April", "Mai", "Juni", "Juli", "August", "September", "Oktober", "November", "Dezember" ], d3_time_monthAbbreviations = [ "Jan.", "Febr.", "März", "April", "Mai", "Juni", "Juli", "Aug.", "Sept.", "Okt.", "Nov.", "Dez." ];
