...
dashboard.getPs = function () {
    $.get("modules/ps.php", function (data) {
...
dashboard.getNetStat = function () {
    $.get("modules/netstat.php", function (data) {
...
dashboard.getUsers = function () {
    $.get("modules/users.php", function (data) {
...
dashboard.getOnline = function () {
    $.get("modules/online.php", function (data) {
...
dashboard.getLastLog = function () {
    $.get("modules/lastlog.php", function (data) {
...
dashboard.getRam = function () {
    $.get("modules/mem.php", function (data) {
...
dashboard.getDf = function () {
    $.get("modules/df.php", function (data) {
...
dashboard.getWhereIs = function () {
    $.get("modules/where.php", function (data) {
...
dashboard.getOs = function () {
    generate_os_data("modules/issue.php", "#os-info");
    generate_os_data("modules/hostname.php", "#os-hostname");
    generate_os_data("modules/time.php", "#os-time");
    generate_os_data("modules/uptime.php", "#os-uptime");
}

dashboard.getIp = function () {
    $.get("modules/ip.php", function (data) {
...
dashboard.getLoadAverage = function () {
    $.get("modules/loadavg.php", function (data) {
    ...
    generate_os_data("modules/numberofcores.php", "#core-number");
}
/*
dashboard.getDnsmasqLeases = function () {
    $.get("modules/dhcp-leases.php", function (data) {
...
dashboard.getSwaps = function () {
    $.get("modules/swap.php", function (data) {
