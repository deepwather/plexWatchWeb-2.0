...
<html lang="en">
  ...
  <body>
		...
		<div class="navbar navbar-fixed-top">
			<div class="navbar-inner">
				...
				<ul class="nav">
                    ...
                    <li class="active"><a href="stats.php"><i class="icon-2x icon-tasks icon-white" data-toggle="tooltip" data-placement="bottom" title="PLEX Stats" id="stats"></i></a></li>
	...
	var opts = {
	  ...
	  "tickFormatX": function (x) { return d3.time.format('%-H:00')(x); },
	  "paddingLeft": ('35'),
	  "paddingRight": ('35'),
	  "paddingTop": ('10'),
	  "tickHintY": ('5'),
	  "mouseover": function (d, i) {
		var pos = $(this).offset();
		$(tt).text(d3.time.format('%-H:00')(d.x) + ' // ' + d.y + ' play(s)')
	...
	var opts = {
	  "dataFormatX": function (x) { return d3.time.format('%Y-%m-%d %H').parse(x); },
	  "tickFormatX": function (x) { return d3.time.format('%e. %b')(x); },
	  "paddingLeft": ('35'),
	  "paddingRight": ('35'),
	  "paddingTop": ('10'),
	  "tickHintY": ('5'),
	...
	var opts = {
	  ...
	  "mouseover": function (d, i) {
		var pos = $(this).offset();
		$(tt).text(d3.time.format('%e. %b')(d.x) + ' // ' + d.y + ' play(s)')
		  .css({top: topOffset + pos.top, left: pos.left + leftOffset})
		  .show();
	  },
	  "mouseout": function (x) {
