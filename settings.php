    ...
    <div class="navbar navbar-fixed-top">
        <div class="navbar-inner">
            ...
            <ul class="nav">
                    ...
                    <li class="active"><a href="settings.php"><i class="icon-2x icon-wrench icon-white" data-toggle="tooltip" data-placement="bottom" title="PlexWatch Settings" id="settings"></i></a></li>
...
<div class="wellbg">
    ...
    <div class="settings-general-info">
        ...
        <ul>
            <li>plexWatch/Web Version: <strong>v2.0</strong></li>
